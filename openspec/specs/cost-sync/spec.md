...
Job diário isolado por provider (AWS/OCI) que busca custos das APIs de billing e faz upsert em PostgreSQL, com backfill inicial de 6 meses e registro de sucesso/falha por execução em `sync_runs`.
