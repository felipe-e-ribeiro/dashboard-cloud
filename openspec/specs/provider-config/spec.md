...
Encrypted, database-backed storage of AWS/OCI credentials and per-provider enable/disable state, configured through an authenticated `/settings` page instead of environment variables or mounted files.
